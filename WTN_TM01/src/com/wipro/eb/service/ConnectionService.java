...
{
	if(currentReading<previousReading||currentReading*previousReading<0)
	{
...
{
	float retval=calculateBillAmt(currentReading,previousReading,type);
	if(retval==-1)
	{
	...
	{
		return "Amount to be paid:"+retval;
	}
}
}
